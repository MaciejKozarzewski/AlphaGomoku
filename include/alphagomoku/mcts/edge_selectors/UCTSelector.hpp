...
#ifndef ALPHAGOMOKU_MCTS_EDGE_SELECTORS_UCTSELECTOR_HPP_
#define ALPHAGOMOKU_MCTS_EDGE_SELECTORS_UCTSELECTOR_HPP_
...
#endif /* ALPHAGOMOKU_MCTS_EDGE_SELECTORS_UCTSELECTOR_HPP_ */
