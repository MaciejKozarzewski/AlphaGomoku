...
cmake -B build/Release -DCMAKE_BUILD_TYPE=Release -DBUILD_WITH_CUDA=ON -DBUILD_WITH_OPENCL=OFF
cmake --build build/Release
...
cmake -B build/Debug -DCMAKE_BUILD_TYPE=Debug -DBUILD_WITH_CUDA=ON -DBUILD_WITH_OPENCL=OFF
cmake --build build/Debug
